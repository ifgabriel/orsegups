...
const SelectComponent = ({ label, feedback, onChangeValue, options, defaultValue }: SelectProps) => {
    ...
    return (
        <View>
            ...
            <TouchableOpacity style={styles.input} onPress={() => setModalVisible(true)}>
                <Text style={styles.selectButtonText}>{options.filter((option) => option.value === selectedValue)[0]?.label}</Text>
            </TouchableOpacity>
